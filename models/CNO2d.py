...
from models.training.filtered_networks import LReLu, LReLu_regular, LReLu_torch #Either "filtered LReLU" or regular LReLu
from models.debug_tools import format_tensor_size
...
class CNO(nn.Module):
    def __init__(self,  
                 ...
                 radial = True,            # Filter property 5. Is filter radial?
                 ...
                 activation = 'lrelu'   # Activation function can be 'cno_lrelu' or 'lrelu'
                ):
